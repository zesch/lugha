...
public class DiacriticsRemover
{
     ...
     * 
     * @param text
     *            The input text, e.g.: "قَامَ الْقَسَمِ الْعَرَبِيِّ فِيْ جُوْجِلْ بِبَرْمَجَةٌ
     *            أَدَاةِ مُفِيْدَةٍ تَقُوْمُ بِتَشْكِيْلَ الْكَلِمَاتِ"
     * 
     * @return The text without diacritics, e.g. "قام القسم العربي في جوجل ببرمجة أداة مفيدة تقوم
     *         بتشكيل الكلمات"
     */
    ...
    /**
     * To remove last letter diacritics (case-endings), sometimes the last letter has 2 diacritics
     * (one of them is Shadda), this is why it is recursive method
     * 
     * @param text
     * @return
     */
    public static String removeLastLetterDiacritics(String text)
    {
        ...
        if (hasCaseEndings(normalizedWord)) {
            return removeLastLetterDiacritics(
                    normalizedWord.substring(0, normalizedWord.length() - 1));
        }
        return str;
    }
}
